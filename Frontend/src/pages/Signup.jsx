...
//           <h2 className="card-title justify-center text-3xl">CodeSmash</h2> {/* Centered title */}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200"> {/* Added a light bg for contrast */}
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">CodeSmash</h2> {/* Added mb-6 for spacing */}
          <form onSubmit={handleSubmit(onSubmit)}>
            {/* First Name Field */}
            <div className="form-control">
...
//     password: z.string().min(8,"Password should contain atleast 8 charcter and special character")
// })
...
// return(
//     <>
//     <form onSubmit={handleSubmit(submittedData)} className='min-h-screen flex flex-col justify-center items-center gap-y-2 max-w-xl ml-100 '>
